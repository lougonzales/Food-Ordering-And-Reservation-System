      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="bold active"><a href="table.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Table Reservation</a>
                </li>
                </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Reservation</h5>
              </div>
            </div>
          </div>
        </div>
